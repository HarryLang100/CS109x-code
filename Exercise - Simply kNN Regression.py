"""
Created on Sat Nov 18 13:53:51 2023
...
#%% Create some synthetic values (that might not be in the actual dataset)
...
# ax.plot(x_train, y_train,'x',label='train',color='k') with x_test and y_test
